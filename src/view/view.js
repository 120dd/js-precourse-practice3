...
export class View {
	...
	renderVendingMachine(vendingMachine) {
		this.renderProductList(vendingMachine.products);
		this.renderPurchaseList(vendingMachine.products);
		this.renderMachineCoins(vendingMachine);
		this.renderUserBalance(vendingMachine.userBalance);
		this.renderReturnCoins(vendingMachine);
	}
}
